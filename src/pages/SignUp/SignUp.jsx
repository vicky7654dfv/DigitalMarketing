...
export default function SignUp() {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Welcome to the Creative Hub!\nAccount created for: ${form.name}`);
    navigate("/Error"); 
  };
    ...
    <div className={Style.mainWrapper}>
      ...
      <div className={Style.signUpWrap}>
        ...
        <div className={Style.pageHeading}>
          ...
          <p>Join the next generation of digital marketers and creative strategists.</p>
        </div>
          ...
          <div className={Style.imageSection}>
            <div className={Style.imageContent}>
              ...
              <div className={Style.imageOverlay}>
                <h3>Dominate the Feed</h3>
                <p>
                  Connect with top-tier tools for SEO, viral campaigns, and data-driven growth.
                </p>
                <div className={Style.featureList}>
                  <span><i className="fa-solid fa-rocket"></i> Viral Campaigns</span>
                  <span><i className="fa-solid fa-chart-line"></i> Data Analytics</span>
                  <span><i className="fa-solid fa-bullseye"></i> Targeted SEO</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className={Style.signUpForm} onSubmit={handleSubmit}>
              ...
              {form.password && (
                <div className={Style.passwordRequirements}>
                  <p className={Style.reqTitle}>Security Level:</p>
              ...
              <button type="submit" className={Style.submitBtn}>
                Launch Account <i className="fa-solid fa-arrow-right"></i>
              </button>
