...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    alert("Thank you for reaching out! Our marketing team will connect with you shortly.");
    navigate("/Error");
  };
    ...
    <div data-aos="fade" className={Style.contactContainer}>
      ...
      <div className={Style.contactContent}>
        ...
        <div className={Style.contactHeader}>
          <h1 className={Style.contactTitle}>Let's Grow Your Brand</h1>
          <p className={Style.contactSubtitle}>
            Ready to dominate the digital landscape? Whether it's SEO, 
            Paid Ads, or creative Branding, we are here to deliver measurable results.
          </p>
        </div>
        ...
        <div className={Style.contactMain}>
          ...
          <div className={Style.contactInfo}>
            ...
            <p className={Style.infoIntro}>
              Reach out to our strategists for a free audit or visit our creative hub.
            </p>
              ...
              <form className={Style.contactForm} onSubmit={handleSubmit}>
                ...
                <div className={Style.formGroup}>
                  ...
                  <select id="service" name="service" autoComplete="service" required>
                    ...
                    <option value="ppc">PPC Advertising (Google/Meta)</option>
